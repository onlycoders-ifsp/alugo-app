    ...
    return {
        ...
        block: function (t, e) {
            var a,
                ...
                i =
                    '<span class="spinner ' +
                    ((e = $.extend(!0, { opacity: 0.05, overlayColor: "#000000", type: "", size: "", state: "primary", centerX: !0, centerY: !0, message: "", shadow: !0, width: "auto" }, e)).type ? "spinner-" + e.type : "") +
                    " " +
                ...
                onScrollSticky: function (t) {
                    ...
                    if (!isNaN(e)) {
                        ...
                        n >= e && !1 === KTUtil.hasClass(i, "card-sticky-on")
                            ...
                            : 1.5 * n <= e && KTUtil.hasClass(i, "card-sticky-on") && (l.eventTrigger("stickyOff"), KTUtil.removeClass(i, "card-sticky-on"), l.resetSticky());
                    }
                },
                ...
                build: function () {
                    ...
                    window.addEventListener("scroll", function () {
                        ...
                        (KTUtil.isBreakpointDown("lg") && !1 === a.options.offset.tabletAndMobile) ||
                            ...
                            (KTUtil.isBreakpointUp("lg") ? (o = a.options.offset.desktop) : KTUtil.isBreakpointDown("lg") && (o = a.options.offset.tabletAndMobile),
                            (n = KTUtil.getScrollTop()),
                            (KTUtil.isBreakpointDown("lg") && a.options.releseOnReverse.tabletAndMobile) || (KTUtil.isBreakpointUp("lg") && a.options.releseOnReverse.desktop)
                                ? (n > o && e < n
                                      ? (!1 === i.hasAttribute("data-header-scroll") && i.setAttribute("data-header-scroll", "on"), t && (l.eventTrigger("scrollOn", a), (t = !1)))
                                      : (!0 === i.hasAttribute("data-header-scroll") && i.removeAttribute("data-header-scroll"), 0 == t && (l.eventTrigger("scrollOff", a), (t = !0))),
                                  (e = n))
                                : n > o
                                ? (!1 === i.hasAttribute("data-header-scroll") && i.setAttribute("data-header-scroll", "on"), t && (l.eventTrigger("scrollOn", a), (t = !1)))
                                : (!0 === i.hasAttribute("data-header-scroll") && i.removeAttribute("data-header-scroll"), 0 == t && (l.eventTrigger("scrollOff", a), (t = !0))));
            ...
            r = {
                ...
                build: function () {
                    (a.eventHandlers.event_1 = KTUtil.on(i, ".menu-toggle", "click", r.handleSubmenuAccordion)),
                        ("dropdown" === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) &&
                            ((a.eventHandlers.event_2 = KTUtil.on(i, '[data-menu-toggle="hover"]', "mouseover", r.handleSubmenuDrodownHoverEnter)),
                ...
                scrollInit: function () {
                    a.options.scroll && a.options.scroll.height
                        ? (KTUtil.scrollDestroy(i, !0),
                          KTUtil.scrollInit(i, { mobileNativeScroll: !0, windowScroll: !1, resetHeightOnDestroy: !0, handleWindowResize: !0, height: a.options.scroll.height, rememberPosition: a.options.scroll.rememberPosition }))
                        : KTUtil.scrollDestroy(i, !0);
                },
                ...
                getSubmenuMode: function (t) {
                    return KTUtil.isBreakpointUp("lg")
                        ? t && KTUtil.hasAttr(t, "data-menu-toggle") && "hover" == KTUtil.attr(t, "data-menu-toggle")
                            ...
                            : void 0
                        : KTUtil.isBreakpointUp("md") && KTUtil.isBreakpointDown("lg") && KTUtil.isset(a.options.submenu, "tablet")
                        ? a.options.submenu.tablet
                        : !(!KTUtil.isBreakpointDown("md") || !KTUtil.isset(a.options.submenu, "mobile")) && a.options.submenu.mobile;
                },
                    ...
                    if (e)
                        for (var a = 0, n = e.length; a < n; a++) {
                            ...
                            KTUtil.css(o, "display", ""),
                                ...
                                o.hasAttribute("data-hor-direction") && (KTUtil.removeClass(o, "menu-submenu-left"), KTUtil.removeClass(o, "menu-submenu-right"), KTUtil.addClass(o, o.getAttribute("data-hor-direction")));
                        }
                },
                ...
                handleSubmenuDropdownClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        !1 !== r.eventTrigger("submenuToggle", this, t) &&
                            ...
                            (!1 === KTUtil.hasClass(e, "menu-item-hover") ? (KTUtil.addClass(e, "menu-item-open-dropdown"), r.showSubmenuDropdown(e)) : (KTUtil.removeClass(e, "menu-item-open-dropdown"), r.hideSubmenuDropdown(e, !0)),
                            t.preventDefault());
                    }
                },
                handleSubmenuDropdownTabClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        !1 !== r.eventTrigger("submenuToggle", this, t) &&
                            "accordion" != e.getAttribute("data-menu-submenu-mode") &&
                            (0 == KTUtil.hasClass(e, "menu-item-hover") && (KTUtil.addClass(e, "menu-item-open-dropdown"), r.showSubmenuDropdown(e)), t.preventDefault());
                    }
                },
                ...
                showSubmenuDropdown: function (t) {
                    ...
                    s &&
                        ...
                        (KTUtil.hasClass(s, "menu-submenu-left") ? s.setAttribute("data-hor-direction", "menu-submenu-left") : KTUtil.hasClass(s, "menu-submenu-right") && s.setAttribute("data-hor-direction", "menu-submenu-right")),
                        s && !0 === KTUtil.isOffscreen(s, "left", 15)
                            ? (KTUtil.removeClass(s, "menu-submenu-left"), KTUtil.addClass(s, "menu-submenu-right"))
                            : s && !0 === KTUtil.isOffscreen(s, "right", 15) && (KTUtil.removeClass(s, "menu-submenu-right"), KTUtil.addClass(s, "menu-submenu-left")),
        ...
        var o = { attrCustom: "" },
            l = {
                ...
                toggleClass: function (t) {
                    ...
                    if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target) for (var i in a.options.toggleBy) a.options.toggleBy[i].target === n && (e = a.options.toggleBy[i]);
                ...
                init: function (t) {
                    (n.element = i),
                        ...
                        "class" == n.options.targetToggleMode
                            ...
                            : (n.state = KTUtil.hasAttr(n.target, "data-" + n.targetState) ? KTUtil.attr(n.target, "data-" + n.targetState) : "off");
                },
                build: function () {
    ...
    return {
        ...
        addClass: function (t, e) {
            if (t && void 0 !== e) {
                ...
                else if (!KTUtil.hasClass(t, e)) for (var i = 0; i < a.length; i++) t.className += " " + KTUtil.trim(a[i]);
            }
        },
        removeClass: function (t, e) {
            if (t && void 0 !== e) {
                ...
                else if (KTUtil.hasClass(t, e)) for (var i = 0; i < a.length; i++) t.className = t.className.replace(new RegExp("\\b" + KTUtil.trim(a[i]) + "\\b", "g"), "");
            }
        },
        ...
        offset: function (t) {
            var e, a;
            if (t) return t.getClientRects().length ? ((e = t.getBoundingClientRect()), (a = t.ownerDocument.defaultView), { top: e.top + a.pageYOffset, left: e.left + a.pageXOffset }) : { top: 0, left: 0 };
        },
        height: function (t) {
        ...
        scrollInit: function (t, e) {
            if (t) {
                (e = KTUtil.deepExtend({}, { wheelSpeed: 0.5, swipeEasing: !0, wheelPropagation: !1, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: !0 }, e)),
                    a(),
                    ...
                    if (((n = parseInt(n)), (!e.mobileNativeScroll && !e.disableForMobile) || !0 !== KTUtil.isMobileDevice()))
                        if ((n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll)) KTUtil.css(t, "overflow", "auto");
                            ...
                            "true" == KTUtil.attr(t, "data-window-scroll") && (e.windowScroll = !0),
                                (a = KTUtil.data(t).get("ps")) ? a.update() : (KTUtil.css(t, "overflow", "hidden"), KTUtil.addClass(t, "scroll"), (a = new PerfectScrollbar(t, e)), KTUtil.data(t).set("ps", a));
    ...
    (function (t) {
        ...
        (t.fn.KTDatatable = function (i) {
                ...
                var l = {
                    ...
                    init: function (e) {
                        ...
                        null === e.data.source && (l.extractTable(), (n = !0)),
                            ...
                            ("remote" !== e.data.type && "local" !== e.data.type) ||
                                (!1 === e.data.saveState && l.stateRemove(l.stateId), "local" === e.data.type && "object" == typeof e.data.source && (o.dataSet = o.originalDataSet = l.dataMapCallback(e.data.source)), l.dataRender()),
                    ...
                    layoutUpdate: function () {
                        l.setupSubDatatable.call(),
                            ...
                            l.resetScroll(),
                            l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(), t(o.table).find(".datatable-row").css("height", "")),
                            l.columnHide.call(),
                            l.rowEvenOdd.call(),
                            l.sorting.call(),
                            l.scrollbar.call(),
                            l.isInit || (l.dropdownFix(), t(o).trigger("datatable-on-init", { table: t(o.wrap).attr("id"), options: i }), (l.isInit = !0)),
                                                ...
                                                !(function (a) {
                                                    if (t(a).find(".datatable-lock").length > 0) l.log("Locked container already exist in: ", a);
                                                        ...
                                                        t(a)
                                                            ...
                                                            e.lockEnabled.left.length > 0 && (t(o.wrap).addClass("datatable-lock"), t(n).appendTo(a)),
                                                            (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(i).appendTo(a),
                                                            e.lockEnabled.right.length > 0 && (t(o.wrap).addClass("datatable-lock"), t(r).appendTo(a));
                    ...
                    lockEnabledColumns: function () {
                        ...
                        return (
                            t.each(n, function (t, n) {
                                void 0 !== n.locked &&
                                    (void 0 !== n.locked.left && a.getBreakpoint(n.locked.left) <= e && o.left.push(n.locked.left), void 0 !== n.locked.right && a.getBreakpoint(n.locked.right) <= e && o.right.push(n.locked.right));
                            }),
                            o
                        );
                    },
                    ...
                    setupBaseDOM: function () {
                        (o.initialDatatable = t(o).clone()),
                            ...
                            void 0 === t(o).attr("id") && (l.setOption("data.saveState", !1), t(o.table).attr("id", a.getUniqueID("datatable-"))),
                            ...
                            void 0 !== i.layout.footer && i.layout.footer && ((o.tableFoot = t(o.table).find("tfoot")), 0 === t(o.tableFoot).length && (o.tableFoot = t("<tfoot/>").appendTo(o.table)));
                    },
                            ...
                            init: function () {
                                ...
                                if (i.layout.scroll) {
                                    ...
                                    t(r).find(".datatable-row").length > 0 && t(r).length > 0
                                        ? ((e.scrollHead = t(o.tableHead).find("> .datatable-lock-scroll > .datatable-row")),
                    ...
                    initScrollbar: function (e, n) {
                        if (e && e.nodeName) {
                            ...
                            a.hasClass(e, "ps") && void 0 !== i
                                ? i.update()
                                : ((i = new PerfectScrollbar(e, Object.assign({}, { wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: l.getOption("rows.autoHide") && !l.isLocked() }, n))),
                                  t(e).data("ps", i)),
                                t(window).resize(function () {
                                    i.update();
                                });
                    ...
                    dataRender: function (e) {
                        ...
                        "local" === i.data.type || (!1 === i.data.serverSorting && "sort" === e) || (!1 === i.data.serverFiltering && "search" === e)
                            ? setTimeout(function () {
                                  l.setAutoColumns(), n();
                              })
                            : l.getData().done(n);
                        ...
                        var i = {
                            ...
                            init: function (e) {
                                (i.meta = e),
                                    ...
                                    t(i.pager).hasClass("datatable-paging-loaded") ||
                                        (t(i.pager).remove(),
                                        0 !== i.meta.pages &&
                                            (l.setDataSourceParam("pagination", { page: i.meta.page, pages: i.meta.pages, perpage: i.meta.perpage, total: i.meta.total }),
                            ...
                            populate: function () {
                                if (((o.dataSet = o.dataSet || []), 0 !== o.dataSet.length)) {
                                    ...
                                    (i.pagerLayout.pagination = n),
                                        t("<li/>")
                                            .append(t("<a/>").attr("title", a.first).addClass("datatable-pager-link datatable-pager-link-first").append(t("<i/>").addClass(e.first)).on("click", i.gotoMorePage).attr("data-page", 1))
                                            .appendTo(n),
                                        t("<li/>")
                                            .append(t("<a/>").attr("title", a.prev).addClass("datatable-pager-link datatable-pager-link-prev").append(t("<i/>").addClass(e.prev)).on("click", i.gotoMorePage))
                                            .appendTo(n),
                                        t("<li/>")
                                            .append(
                                                t("<input/>")
                                    ...
                                    t("<li/>")
                                        .append(t("<a/>").attr("title", a.next).addClass("datatable-pager-link datatable-pager-link-next").append(t("<i/>").addClass(e.next)).on("click", i.gotoMorePage))
                                        .appendTo(n),
                                        t("<li/>")
                                            .append(t("<a/>").attr("title", a.last).addClass("datatable-pager-link datatable-pager-link-last").append(t("<i/>").addClass(e.last)).on("click", i.gotoMorePage).attr("data-page", i.meta.pages))
                                            .appendTo(n),
                            ...
                            paginationUpdate: function () {
                                ...
                                t(n).each(function (e, a) {
                                    ...
                                    1 === i.meta.page
                                        ? (t(r).attr("disabled", !0).addClass("datatable-pager-link-disabled"), t(s).attr("disabled", !0).addClass("datatable-pager-link-disabled"))
                                        : (t(r).removeAttr("disabled").removeClass("datatable-pager-link-disabled"), t(s).removeAttr("disabled").removeClass("datatable-pager-link-disabled")),
                                    i.meta.page === i.meta.pages
                                        ? (t(d).attr("disabled", !0).addClass("datatable-pager-link-disabled"), t(c).attr("disabled", !0).addClass("datatable-pager-link-disabled"))
                                        : (t(d).removeAttr("disabled").removeClass("datatable-pager-link-disabled"), t(c).removeAttr("disabled").removeClass("datatable-pager-link-disabled"));
                            ...
                            if (void 0 !== i.responsive || void 0 !== i.visible) {
                                ...
                                setTimeout(function () {
                                    !1 === l.getObject("visible", i)
                                        ? t(s).hide()
                                        : (a.getBreakpoint(l.getObject("responsive.hidden", i)) >= e ? t(s).hide() : t(s).show(), a.getBreakpoint(l.getObject("responsive.visible", i)) <= e ? t(s).show() : t(s).hide());
                                });
                            }
                        });
                    },
                        ...
                        if ("function" == typeof e && !(t(o.table).find(".datatable-subtable").length > 0)) {
                            ...
                            var a = function (a) {
                                    ...
                                    t(n).hasClass("datatable-row-subtable-expanded")
                                        ? (t(c).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).removeClass("datatable-row-subtable-expanded"), t(o).trigger("datatable-on-collapse-subtable", [n]))
                                        : (t(c).addClass(l.getOption("layout.icons.rowDetail.expand")), t(n).addClass("datatable-row-subtable-expanded"), t(o).trigger("datatable-on-expand-subtable", [n])),
                                                ...
                                                if (void 0 !== o.subtable && o.subtable) {
                                                    ...
                                                    t(i).html(
                                                        t("<a/>")
                                                            ...
                                                            .on("click", a)
                                                            .append(t("<i/>").css("width", t(i).data("width")).addClass(l.getOption("layout.icons.rowDetail.collapse")))
                                                    );
                                                }
                                            }
                                        });
                                    ...
                                    (void 0 !== a && !1 === a.visible) ||
                                        t(s).append(
                                            t('<tr class="datatable-row"></tr>')
                                                .append(t('<td class="datatable-cell"></td>').append(t("<span/>").append(a.title)))
                                                .append(this)
                                        );
                                }),
                                    t(r).append(s);
                                        ...
                                        .each(function () {
                                            0 === t(this).find(".datatable-toggle-detail").length &&
                                                ...
                                                0 === t(o.tableHead).find(".datatable-toggle-detail").length
                                                    ? (t(o.tableHead).find(".datatable-row").first().prepend('<th class="datatable-cell datatable-toggle-detail"><span></span></th>'),
                                                      t(o.tableFoot).find(".datatable-row").first().prepend('<th class="datatable-cell datatable-toggle-detail"><span></span></th>'))
                    ...
                    setAutoColumns: function () {
                        l.getOption("data.autoColumns") &&
                            ...
                            l.setHeadTitle(),
                            l.getOption("layout.footer") && (t(o.tableFoot).find(".datatable-row").remove(), l.setHeadTitle(o.tableFoot)));
                    },
                    isLocked: function () {
                        ...
                        var e = {
                            ...
                            sortClick: function (n) {
                                ...
                                if (
                                    ...
                                    (t(o.tableHead).find("th").removeClass("datatable-cell-sorted"), a.addClass(this, "datatable-cell-sorted"), t(o.tableHead).find(".datatable-cell > span > i").remove(), i.sortable)
                                ) {
                                    l.spinnerCallback(!0);
                                    var c = "desc";
                    ...
                    localDataUpdate: function () {
                        ...
                        if (
                            ...
                            void 0 !== s && "" !== s && ((s = s.toLowerCase()), (o.dataSet = t.grep(o.dataSet, r)), delete e.query[l.getGeneralSearchKey()]),
                    ...
                    rowEvenOdd: function () {
                        t(o.tableBody).find(".datatable-row").removeClass("datatable-row-even"),
                            t(o.wrap).hasClass("datatable-subtable")
                                ? t(o.tableBody).find(".datatable-row:not(.datatable-row-detail):even").addClass("datatable-row-even")
                        ...
                        void 0 !== a && (a = t.makeArray(a)),
                            (n = function () {
                                ...
                                "object" == typeof a &&
                                    ...
                                    o.setDataSourceParam("pagination", Object.assign({}, o.getDataSourceParam("pagination"), { page: 1 })),
                    ...
                    setDataSourceParam: function (e, a) {
                        (o.API.params = t.extend({}, { pagination: { page: 1, perpage: l.getOption("data.pageSize") }, sort: l.getDefaultSortColumn(), query: {} }, o.API.params, l.stateGet(l.stateId))),
                    ...
                    visible: function (e) {
                        if (t(l.recentNode.length)) {
                            ...
                            e ? (l.recentNode === l.nodeCols && delete i.columns[n].visible, t(l.recentNode).show()) : (l.recentNode === l.nodeCols && l.setOption("columns." + n + ".visible", !1), t(l.recentNode).hide()),
                                l.columnHide(),
                                l.redraw();
                        }
                    },
                ...
                if (
                    ...
                    if ("string" == typeof i) {
                        ...
                        o.data(e) ||
                            ...
                            ((o.dataSet = null),
                            (o.textAlign = { left: "datatable-cell-left", center: "datatable-cell-center", right: "datatable-cell-right" }),
            ...
            (t.fn.KTDatatable.defaults = {
                data: { type: "local", source: null, pageSize: 10, saveState: !0, serverPaging: !1, serverFiltering: !1, serverSorting: !1, autoColumns: !1, attr: { rowProps: [] } },
                layout: {
                    theme: "default",
                ...
                var n = {
                    ...
                    initEvent: function () {
                        t(e.tableHead)
                            ...
                            t(e.tableBody)
                                ...
                                .click(function (i) {
                                    var o = t(this).val();
                                    t(this).is(":checked") ? (n.selectedRows.push(o), (n.unselectedRows = n.remove(n.unselectedRows, o))) : (n.unselectedRows.push(o), (n.selectedRows = n.remove(n.selectedRows, o))),
                    ...
                    initSelect: function () {
                        n.selectedAllRows && a.vars.requestIds
                            ? (e.hasClass("datatable-error") || t(e.tableHead).find('.checkbox-all > [type="checkbox"]').prop("checked", !0),
                              e.setActiveAll(!0),
...
KTUtil.isRTL() &&
    ...
    KTUtil.ready(function () {
        void 0 !== KTLayoutHeader && KTLayoutHeader.init("kt_header", "kt_header_mobile"),
            ...
            void 0 !== KTLayoutSidebar && KTLayoutSidebar.init("kt_sidebar"),
    ...
    return {
        init: function (n) {
            ...
            ((e = KTUtil.getById(n)), (t = KTUtil.getBody()), e) &&
                ((o = "1" === KTUtil.attr(e, "data-menu-dropdown") ? "dropdown" : "accordion"),
                ...
                (a = new KTMenu(e, { scroll: i, submenu: { desktop: o, tablet: "accordion", mobile: "accordion" }, accordion: { expandAll: !1 } })),
                            ...
                            !1 !== KTUtil.isBreakpointUp("lg") &&
                                ...
                                (r = setTimeout(function () {
                                    KTUtil.hasClass(t, "aside-minimize-hover") &&
                                        ...
                                        (KTUtil.removeClass(t, "aside-minimize-hover"), KTLayoutAsideMenu.getMenu().scrollUpdate(), KTLayoutAsideMenu.getMenu().scrollTop());
                                }, 100)));
                    })));
        },
        getElement: function () {
    ...
    return {
        init: function (n) {
            (e = KTUtil.getById(n)),
                (t = KTUtil.getBody()),
                e &&
                    ((a = new KTToggle(e, t, { targetState: "aside-minimize", toggleState: "active" })).on("toggle", function (e) {
...
var KTLayoutAside = (function () {
    ...
    return {
        init: function (n) {
            var i;
            ((e = KTUtil.getById(n)), (t = KTUtil.getBody()), e) &&
                ((i = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside"),
                (a = new KTOffcanvas(e, { baseClass: i, overlay: !0, closeBy: "kt_aside_close_btn", toggleBy: { target: "kt_aside_mobile_toggle", state: "mobile-toggle-active" } })));
        },
        getElement: function () {
            return e;
        },
    ...
    return {
        init: function (i, o) {
            (t = KTUtil.getById(i)),
                (a = KTUtil.getById(o)),
                t &&
                    ((n = new KTOffcanvas(a, { overlay: !0, baseClass: "header-menu-wrapper", closeBy: "kt_header_menu_mobile_close_btn", toggleBy: { target: "kt_header_mobile_toggle", state: "mobile-toggle-active" } })),
                    (e = new KTMenu(t, { submenu: { desktop: "dropdown", tablet: "accordion", mobile: "accordion" }, accordion: { slideSpeed: 200, expandAll: !1 } })));
        },
...
var KTLayoutSidebar = (function () {
                ...
                i &&
                    KTUtil.scrollInit(i, {
                        ...
                        height: function () {
                            var t = parseInt(KTUtil.getViewPort().height);
                            return (
                                KTUtil.isBreakpointUp("lg") && (t -= KTLayoutHeader.getHeight()),
                                n && ((t -= parseInt(KTUtil.css(n, "height"))), (t -= parseInt(KTUtil.css(n, "marginTop"))), (t -= parseInt(KTUtil.css(n, "marginBottom")))),
                                i && ((t -= parseInt(KTUtil.css(i, "marginTop"))), (t -= parseInt(KTUtil.css(i, "marginBottom")))),
                                (t -= parseInt(KTUtil.css(a, "paddingTop"))),
                                (t -= parseInt(KTUtil.css(a, "paddingBottom"))),
    ...
    return {
        init: function (o) {
            var l;
            ((e = KTUtil.getById(o)), (t = KTUtil.getBody()), e) &&
                ((a = new KTOffcanvas(e, { baseClass: "sidebar", overlay: !0, closeBy: "kt_sidebar_close", toggleBy: { target: "kt_sidebar_mobile_toggle", state: "active" } })),
                (l = KTUtil.find(e, ".sidebar-nav")) &&
                    (KTUtil.scrollInit(l, {
                        disableForMobile: !0,
                        resetHeightOnDestroy: !0,
                        handleWindowResize: !0,
                        height: function () {
                            ...
                            return (
                                (t -= parseInt(KTUtil.css(a, "height"))),
                                (t -= parseInt(KTUtil.css(a, "marginBottom")) + parseInt(KTUtil.css(a, "marginTop"))),
                                (t -= parseInt(KTUtil.css(n, "height"))) - (parseInt(KTUtil.css(n, "marginBottom")) + parseInt(KTUtil.css(n, "marginTop")))
                            );
                        },
                    }),
                        ...
                        position: {
                            top: function () {
                                ...
                                return (
                                    KTUtil.getBody(),
                                    KTUtil.isBreakpointUp("lg")
                                        ? (KTLayoutHeader.isFixed() && (t += KTLayoutHeader.getHeight()), KTLayoutSubheader.isFixed() && (t += KTLayoutSubheader.getHeight()))
                                        : KTLayoutHeader.isFixedForMobile() && (t += KTLayoutHeader.getHeightForMobile()),
                                    t
                                );
                            },
                            left: function (e) {
...
var KTLayoutStretchedCard = (function () {
    var t,
        e = function () {
            ...
            (i =
                (i =
                    (i = (i = (i -= parseInt(KTUtil.actualHeight(n))) - parseInt(KTUtil.css(t, "marginTop")) - parseInt(KTUtil.css(t, "marginBottom"))) - parseInt(KTUtil.css(t, "paddingTop")) - parseInt(KTUtil.css(t, "paddingBottom"))) -
        ...
        e = function (t) {
            ...
            if (0 !== n.value.length) {
                ...
                (l += '<div class="d-flex align-items-center">'),
                    ...
                    (l += '\t\t<img alt="Pic" src="assets/media/users/150-9.jpg"/>'),
                    (l += "\t</div>"),
                    (l += "</div>"),
                    ...
                    setTimeout(function () {
                        ...
                        KTUtil.setHTML(
                            t,
                            '<div class="d-flex align-items-center">\t<div class="symbol symbol-circle symbol-40 mr-3">\t\t<img alt="Pic" src="assets/media/users/150-11.jpg"/>\t</div>\t<div>\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</a>\t\t<span class="text-muted font-size-sm">Just now</span>\t</div></div><div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">Right before vacation season we have the next Big Deal for you.</div>'
                        ),
                            e.appendChild(t),
                            (n.value = ""),
                            (a.scrollTop = parseInt(KTUtil.css(e, "height"))),
                ...
                (!(function () {
                    ...
                    KTUtil.scrollInit(i, {
                        ...
                        height: function () {
                            ...
                            return (
                                a && ((e -= parseInt(KTUtil.actualHeight(a))), (e -= parseInt(KTUtil.css(a, "marginTop"))), (e -= parseInt(KTUtil.css(a, "marginBottom")))),
                                n && ((e -= parseInt(KTUtil.css(n, "marginTop"))), (e -= parseInt(KTUtil.css(n, "marginBottom")))),
                                i && ((e -= parseInt(KTUtil.css(i, "marginTop"))), (e -= parseInt(KTUtil.css(i, "marginBottom")))),
                                o && ((e -= parseInt(KTUtil.actualHeight(o))), (e -= parseInt(KTUtil.css(o, "marginTop"))), (e -= parseInt(KTUtil.css(o, "marginBottom")))),
    ...
    return {
        init: function (e) {
            ...
            (t = KTUtil.getById(e)) &&
                ...
                (n = KTUtil.find(t, ".offcanvas-content")),
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_actions_close", toggleBy: "kt_quick_actions_toggle" }),
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
                ...
                (function () {
                    ...
                    KTUtil.scrollInit(n, {
                        ...
                        height: function () {
                            ...
                            return (
                                e && ((o -= parseInt(KTUtil.actualHeight(e))), (o -= parseInt(KTUtil.css(e, "marginTop"))), (o -= parseInt(KTUtil.css(e, "marginBottom")))),
                                a && ((o -= parseInt(KTUtil.css(a, "marginTop"))), (o -= parseInt(KTUtil.css(a, "marginBottom")))),
                                n && ((o -= parseInt(KTUtil.css(n, "marginTop"))), (o -= parseInt(KTUtil.css(n, "marginBottom")))),
                                i && ((o -= parseInt(KTUtil.actualHeight(i))), (o -= parseInt(KTUtil.css(i, "marginTop"))), (o -= parseInt(KTUtil.css(i, "marginBottom")))),
    ...
    return {
        init: function (e) {
            ...
            (t = KTUtil.getById(e)) &&
                ((a = KTUtil.find(t, ".offcanvas-header")),
                (n = KTUtil.find(t, ".offcanvas-content")),
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_notifications_close", toggleBy: "kt_quick_notifications_toggle" }),
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
...
var KTLayoutQuickPanel = (function () {
    var t,
        ...
        i = function () {
            ...
            return (
                e && ((n -= parseInt(KTUtil.actualHeight(e))), (n -= parseInt(KTUtil.css(e, "marginTop"))), (n -= parseInt(KTUtil.css(e, "marginBottom")))),
    ...
    return {
        init: function (o) {
            (t = KTUtil.getById(o)),
                ...
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_panel_close", toggleBy: "kt_quick_panel_toggle" }),
                KTUtil.scrollInit(e, {
                    mobileNativeScroll: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
    ...
    return {
        init: function (e) {
            ...
            (t = KTUtil.getById(e)) &&
                ...
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_search_close", toggleBy: "kt_quick_search_toggle" }),
                KTUtil.scrollInit(o, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
    ...
    return {
        init: function (e) {
            ...
            (t = KTUtil.getById(e)) &&
                ((a = KTUtil.find(t, ".offcanvas-header")),
                (n = KTUtil.find(t, ".offcanvas-content")),
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_user_close", toggleBy: "kt_quick_user_toggle" }),
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
