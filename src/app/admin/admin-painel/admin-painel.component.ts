...
export type ChartOcorrenciasOptions = {
  series: ApexNonAxisChartSeries;
  chart: ApexChart;
  responsive: ApexResponsive[];
  labels: any;
...
export type ChartPrincipalOptions = {
  series: ApexAxisChartSeries;
  chart: ApexChart;
  dataLabels: ApexDataLabels;
  plotOptions: ApexPlotOptions;
...
export type ChartOcorrenciasMesOptions = {
  series: ApexAxisChartSeries;
  chart: ApexChart;
  xaxis: ApexXAxis;
  stroke: ApexStroke;
...
export class AdminPainelComponent implements OnInit {
  ...
  @ViewChild("chartBarId") chartBarController: ChartComponent;  
  @ViewChild("chartPrincipal") chartPrincipalController: ChartComponent;
  @ViewChild("chartOcorrencias") chartOcorrenciasController: ChartComponent;
  @ViewChild("chartOcorrenciasMes") chartOcorrenciasMesController: ChartComponent;
  ...
  public chartPrincipalOptions: Partial<ChartPrincipalOptions>;
  public chartOcorrenciasOptions: Partial<ChartOcorrenciasOptions>;
  public chartOcorrenciasMesOptions: Partial<ChartOcorrenciasMesOptions>;
  ...
  ngOnInit(): void {
    this.chartOcorrencias();
    this.chartDonut();
    this.chartBarra();
    this.chartBar();
    this.chartPrincipal();
    this.chartOcorrenciasMes();
  ...
  chartOcorrencias(){
    this.chartOcorrenciasOptions = {
      ...
      labels: ["Aplicação JAVA", "PostGressSQL"],
      responsive: [
        {
          breakpoint: 480,
          options: {
  ...
  chartPrincipal(){
    this.chartPrincipalOptions = {
      series: [
        {
          name: "Registro de Erros",
      ...
      xaxis: {
        categories: [
          ...
          ["aluguel/alugar"],
          "admin/inativa-usuario",
          ["oauth/login"],
          ["oauth/token"],
          ["idioma/getidioma"],
          ["usuario/inativa-produto"]
        ],
        labels: {
          style: {
            colors: [
  ...
  chartOcorrenciasMes(){
    this.chartOcorrenciasMesOptions = {
      series: [
        {
          name: "PostGresSQL",
